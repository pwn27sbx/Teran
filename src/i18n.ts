...
const resources = {
  "es": {
    "translation": {
      ...
      "home.why_us_desc": "Veterinarias Terán es sinónimo de profesionalismo y pasión. Son <strong>24 años</strong> salvaguardando el bienestar de las mascotas del Perú, siendo precursores en tecnología médica de punta y capacitación constante de nuestro staff. Cada día es un reto para salvar una vida y mejorar nuestro país.",
