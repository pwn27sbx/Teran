    ...
    <div className="min-h-screen bg-[#f8f9fa] dark:bg-[#121212] flex flex-col font-sans relative overflow-hidden">
      ...
      <main className="flex-1 flex flex-col relative z-10 pt-28 pb-8 px-4 lg:px-8 justify-center">
        <motion.div 
          ...
          className="max-w-[1300px] mx-auto w-full flex flex-col lg:flex-row gap-4 lg:gap-6 items-stretch h-auto lg:h-[calc(100vh-140px)] lg:min-h-[550px] lg:max-h-[700px]"
        >
          ...
          <div className="w-full lg:w-[32%] h-[400px] lg:h-auto relative rounded-[2.5rem] overflow-hidden shadow-xl shadow-[#0277ab]/10 border border-white/40 dark:border-white/10 shrink-0 group">
            ...
            <div className="absolute bottom-8 left-8 right-8 text-white">
              <div className="inline-block bg-white/20 backdrop-blur-md px-3 py-1.5 rounded-full text-[10px] uppercase tracking-widest font-bold mb-4 border border-white/30">Directores</div>
          ...
          <div className="w-full lg:w-[68%] flex flex-col gap-4 lg:gap-6 min-h-0">
            ...
            <div className="bg-white/80 dark:bg-[#1e1e1e]/80 backdrop-blur-2xl rounded-[2.5rem] p-8 lg:p-10 border border-white/60 dark:border-white/10 shadow-xl shadow-gray-200/50 dark:shadow-none shrink-0 flex flex-col md:flex-row gap-8 items-center justify-between">
              <div className="flex-1">
                ...
                <h1 className="text-4xl md:text-5xl font-black text-gray-900 dark:text-white tracking-tight mb-4">Quiénes Somos</h1>
                <p className="text-gray-600 dark:text-gray-400 text-base md:text-lg font-medium leading-relaxed max-w-2xl">
            ...
            <div className="flex flex-col md:flex-row gap-4 lg:gap-6 flex-1 min-h-0">
              ...
              <div className="w-full md:w-[60%] bg-[#0277ab] rounded-[2.5rem] p-8 lg:p-10 text-white flex flex-col justify-center shadow-xl shadow-[#0277ab]/20 relative overflow-hidden">
                <div className="absolute -bottom-24 -right-24 opacity-10 rotate-12">
                  <Star className="w-96 h-96 fill-current" />
                </div>
                <div className="relative z-10 space-y-4 lg:space-y-5 text-[13px] lg:text-sm leading-relaxed text-white/90 font-medium overflow-y-auto pr-2 custom-scrollbar">
                  <p>
              ...
              <div className="w-full md:w-[40%] grid grid-cols-2 grid-rows-2 gap-4 lg:gap-6 shrink-0 md:shrink">
                {stats.map((stat, i) => (
                  <div key={i} className="bg-white/80 dark:bg-[#1e1e1e]/80 backdrop-blur-2xl rounded-[2.5rem] border border-white/60 dark:border-white/10 flex flex-col items-center justify-center p-6 shadow-xl shadow-gray-200/50 dark:shadow-none hover:-translate-y-1 transition-transform cursor-default">
                    ...
                    <span className="text-[10px] font-bold uppercase tracking-widest text-gray-500 text-center">{stat.label}</span>
                  </div>
                ))}
              </div>
